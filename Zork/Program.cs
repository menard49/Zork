...
namespace Zork
{
    ...
    class Program
    {
        ...
        {
            // var roomMap = new Dictonary<string, Room>();
            ...
            //}
             ...
             Rooms[2, 0].Description = "This is a dimly lit forest, with large tress all around. To the east, there appears to be sunlight.";           // Dense Woods 
        ...
        private static readonly List<Commands> Directions = new List<Commands> // private static readonly Commands[] Directions = 
        {
            Commands.NORTH,
            Commands.SOUTH,
            Commands.EAST,
